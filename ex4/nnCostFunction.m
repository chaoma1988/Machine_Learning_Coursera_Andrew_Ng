...
% part 1,
% loop through the examples to compute the cost function
% recode the input y variables to the correct vector form
% for example, if y = 1, then, 

% add bias unit to the input X matrix
...
for i= 1:m
    ...
    KK = -log(A3)*y_recode - (log(1-A3))*(1-y_recode);
